...
typedef enum
{
    LED_1, 	//Green //wait for the whole message
    LED_2, 	//Blue, turn on LED to indicate connection to PC application
    LED_3, 	//Red
    LED_ALL,
    LED_N
} led_t;
...
#if !(EXTI15_10_IRQn) //EXTI15_10_IRQn, EXTI9_5_IRQn
#define DECAIRQ_EXTI_IRQn		(40)
#else
#define DECAIRQ_EXTI_IRQn		(EXTI15_10_IRQn)
#endif

#if !(EXTI4_IRQn) //EXTI4_IRQn, EXTI0_IRQn
